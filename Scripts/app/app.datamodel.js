function AppDataModel() {
    ...
    self.webApiUrl = "http://localhost:17571/api/"; // that's our WebAPI's current URL
    ...
    // function for sending ajax requests to webapi 
    self.webApiRequest = function(type, requestUrl, data, success, fail) {
        return $.ajax(self.webApiUrl + requestUrl, {
            type: type,
            data: data ? data : null,
            success: success,
            fail: fail
